...
class AssetLoader {
    ...
    public function register_assets() {
        ...
        wp_enqueue_script( 'fopsco-validator', get_template_directory_uri() . '/assets/js/validates.js', ['validator'], filemtime(get_template_directory() . '/assets/js/join.js'), true );
